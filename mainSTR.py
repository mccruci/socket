#
#   questo script si occupa dell'elaborazione della stringa
#
...
def main(lista,tsRIcezione):
    listOfDict = readSTR(lista,tsRIcezione)
  
    '''
    with Gestione(listOfDict) as ges:
        ges.main()
        logging.info('SCK:: close Gestione.main')
    '''
    #ges = Gestione(listOfDict)
    #ges.main()
    #logging.info('SCK:: close Gestione.main')
...
if __name__ == '__main__':
    ...
    #print readSTR(lista,tsRIcezione)
    main(lista,tsRIcezione)
